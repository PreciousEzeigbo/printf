...
/**
 * struct printing - struct for printer functions
 * @type_arg: identifier
...
int print_prg(va_list __arguments__, char *buf, unsigned int ibuf);
...
int printing_upx(va_list arguments, char *buf, unsigned int ibuf);
int printing_int(va_list arguments, char *buf, unsigned int ibuf);
int printing_unt(va_list arguments, char *buf, unsigned int ibuf);
int printing_oct(va_list arguments, char *buf, unsigned int ibuf);
...
int prinoct(va_list arguments, char *buf, unsigned int ibuf);
int prinhex(va_list arguments, char *buf, unsigned int ibuf);
int prinupx(va_list arguments, char *buf, unsigned int ibuf);
int prinint(va_list arguments, char *buf, unsigned int ibuf);
int (*get_print_func(const char *s, int index))(va_list, char *, unsigned int);
int ev_print_func(const char *s, int index);
unsigned int hand1_buf(char *buf, char c, unsigned int ibuf);
int print_buf(char *buf, unsigned int nbuf);
char *fill_binary_array(char *binary, long int int_in, int iseng, int limit);
