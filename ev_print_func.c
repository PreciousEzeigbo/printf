...
int ev_print_func(const char *s, int index)
{
	print_t pr[] = {
		...
		{"ld", prinlint}, {"lu", prinlunt}, {"lo", printing_loct},
		{"lx", printing_hex}, {"lX", printing_upx}, {"hi", printing_int},
		{"hd", printing_int}, {"hu", printing_unt}, {"ho", printing_oct},
		{"hx", prinhhex}, {"hX", prinhupx}, {"#o", prinoct},
		{"#x", prinhex}, {"#X", prinupx}, {"#i", print_int},
		{"#d", print_int}, {"#u", print_unt}, {"+i", prinpint},
		{"+d", prinpint}, {"+u", print_unt}, {"+o", print_oct},
		{"+x", print_hex}, {"+X", print_upx}, {" i", prinint},
		{" d", prinint}, {" u", print_unt}, {" o", print_oct},
